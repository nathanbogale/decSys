...
$html .= '<a href="'.$button_url.'" target="'.$link_target_opt.'" class="three-columns client-logo-border js-pointer-large">';
$html .= '<div class="client-logo-border__inner '.$border_color.' hover-box pos-rel js-scrollanim">';
