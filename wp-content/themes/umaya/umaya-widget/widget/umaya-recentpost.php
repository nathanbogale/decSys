 ...
 * @since 2.8.0
 */
class Umaya_Recent_Posts extends WP_Widget {

	function __construct() {
		$widget_ops = array('classname' => 'widget_recent_entries', 'description' => ( "The most recent posts on your site") );
		parent::__construct('umaya-recent-posts', ('Umaya  Recent Posts'), $widget_ops);
...
?>
		...
		<img class="img-hover-scale" src="<?php echo esc_url($umaya_image[0]);?>" alt="<?php the_title();?>">
		</div>
		<h5 class="headline-xxxxs text-color-black margin-top-10 hover-move-right"><?php the_title();?></h5>
...
?>
		<p><label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php esc_html_e( 'Title:','umaya' ); ?></label>
		<input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo $title; ?>" /></p>

		<p><label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php esc_html_e( 'Number of posts to show:','umaya' ); ?></label>
...
register_widget('Umaya_Recent_Posts');