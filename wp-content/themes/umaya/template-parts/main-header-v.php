<?php $umaya_options = get_option('umaya'); ?>
		...
		<header class="fixed-header">
			<!-- logo start -->
			<div class="header-logo <?php if (Umaya_AfterSetupTheme::return_thme_option('textlogo')=='st2'){ ?>vertical<?php } ;?> js-midnight-color js-headroom">
				<div class="hidden-box">
				    ...
				    <img class="header-logo__img white" src="<?php echo esc_url(Umaya_AfterSetupTheme::return_thme_option('logopiclightv','url'));?>" alt="<?php  bloginfo('name'); ?>">
				    <img class="header-logo__img black" src="<?php echo esc_url(Umaya_AfterSetupTheme::return_thme_option('logopicv','url'));?>" alt="<?php  bloginfo('name'); ?>">
					<?php }
					else{ ?>
