...
var elm_button_vars = { wrapper: '#blog-items, ul.products, .portfolio-wrap' };
		...
		$('.dp-adeline-loadmore-button').on('click', function (e) {
			...
			$.ajax({
				...
				success: function() {				
					...
					$('.gallery-format').imagesLoaded( function() {
				...
				if ($(elm_button_vars.wrapper).length) {
					...
					var _carousel = $(elm_button_vars.wrapper).find('.gallery-format');

					_carousel.imagesLoaded( function() {
				...
				if ( nextPage == maxPages ) {
					...
					$('.dp-adeline-loadmore-finished').addClass('active');
