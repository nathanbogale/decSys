 ...
 * Portfolio single content block details right
...
<div class="entry-content  dpr-adeline-row clr"<?php adeline_schema_markup('entry_content'); ?>>
  ...
  <div class="col <?php echo esc_attr($details_column_class) ?> single-portfolio-details details-right <?php echo esc_attr($sticky_class) ?>">
    <?php
