...
if ( version_compare( Adeline_WooCommerce_Config::adeline_get_wc_version(), '2.7', '>=' ) ) {
...
<div class="product-entry-slider woo-entry-image clr">
  <?php do_action('adeline_before_product_entry_image'); ?>
  <?php
...
if ( has_post_thumbnail() ) :
	?>
  <div class="dpr-adeline-slider-slide"> <a href="<?php the_permalink(); ?>" class="woocommerce-LoopProduct-link">
    <?php
...
<?php do_action('adeline_after_product_entry_image'); ?>
<?php
...
wc_get_template(  'loop/thumbnail/single-image.php' );
