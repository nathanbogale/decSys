...
class PortfolioProjectInfo implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Portfolio Project Info', 'holmes-core' ),
					'base'     => $this->getBase(),
					...
					'params'   => array(
						array(
							...
							'heading'     => esc_html__( 'Selected Project', 'holmes-core' ),
							'settings'    => array(
								'sortable'      => true,
								'unique_values' => true
							),
							'description' => esc_html__( 'If you left this field empty then project ID will be of the current page', 'holmes-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'project_info_type',
							'heading'     => esc_html__( 'Project Info Type', 'holmes-core' ),
							'value'       => array(
								esc_html__( 'Title', 'holmes-core' )          => 'title',
								esc_html__( 'Category', 'holmes-core' )       => 'category',
								esc_html__( 'Tag', 'holmes-core' )            => 'tag',
								esc_html__( 'Author', 'holmes-core' )         => 'author',
								esc_html__( 'Date', 'holmes-core' )           => 'date',
								esc_html__( 'Featured Image', 'holmes-core' ) => 'image'
							),
							'admin_label' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Project Title Tag', 'holmes-core' ),
							'value'       => array_flip( holmes_mkdf_get_title_tag( true, array( 'p' => 'p' ) ) ),
							'description' => esc_html__( 'Set title tag for project title element', 'holmes-core' ),
							'dependency'  => array( 'element' => 'project_info_type', 'value' => array( 'title' ) )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'project_info_title',
							'heading'     => esc_html__( 'Project Info Label', 'holmes-core' ),
							'description' => esc_html__( 'Add project info label before project info element/s', 'holmes-core' )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'project_info_title_tag',
							'heading'    => esc_html__( 'Project Info Label Tag', 'holmes-core' ),
							'value'      => array_flip( holmes_mkdf_get_title_tag( true, array( 'p' => 'p' ) ) ),
