                    ...
                    $html .= '<div class="mkdf-ps-prev">';
                        if ( $nav_same_category ) {
                            if(get_previous_post( true, '', 'portfolio-category' )) {
                                ...
                                <div class="mkdf-ps-content-holder"><div class="mkdf-ps-nav-img" style="background-image: url(' . get_the_post_thumbnail_url(get_previous_post(true, '', 'portfolio-category')->ID) . ')"></div><div class="mkdf-ps-title-holder">' . get_previous_post(true, '', 'portfolio-category')->post_title . '</div></div>', true, '', 'portfolio-category');
                            }
                        } else {
                            $html .= get_previous_post_link( '%link', '<span>' . $arrow_left . '</span>
                ...
                if ( get_next_post() !== '' ) {
                    ...
                    if ( $nav_same_category ) {
                        if(get_next_post( true, '', 'portfolio-category' )) {
                            ...
                            <div class="mkdf-ps-content-holder"><div class="mkdf-ps-nav-img" style="background-image: url(' . get_the_post_thumbnail_url(get_next_post(true, '', 'portfolio-category')->ID) . ')"></div><div class="mkdf-ps-title-holder">' . get_next_post(true, '', 'portfolio-category')->post_title . '</div></div>', true, '', 'portfolio-category');
                        }
                    } else {
                        $html .= get_next_post_link( '%link', '<span>' . $arrow_right . '</span>
