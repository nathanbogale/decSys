<?php
$masonry_classes   = '';
$number_of_columns = holmes_mkdf_get_meta_field_intersect( 'portfolio_single_masonry_columns_number' );
if ( ! empty( $number_of_columns ) ) {
	$masonry_classes .= ' mkdf-' . $number_of_columns . '-columns';
}
$space_between_items = holmes_mkdf_get_meta_field_intersect( 'portfolio_single_masonry_space_between_items' );
...
<div class="mkdf-portfolio-single-holder-inner">
    <div class="mkdf-grid-row">
        <div class="mkdf-grid-col-9">
            <div class="mkdf-ps-image-holder mkdf-grid-list mkdf-disable-bottom-space mkdf-grid-masonry-list mkdf-fixed-masonry-items <?php echo esc_attr( $masonry_classes ); ?>">
                <div class="mkdf-ps-image-inner mkdf-outer-space mkdf-masonry-list-wrapper">
                    <div class="mkdf-masonry-grid-sizer"></div>
                    <div class="mkdf-masonry-grid-gutter"></div>
					<?php
					$media = holmes_core_get_portfolio_single_media( true );
