	...
	foreach ( $custom_fields as $custom_field ) : ?>
        <div class="mkdf-ps-info-item mkdf-ps-custom-field">
			<?php if ( ! empty( $custom_field['item_title'] ) ) {
				holmes_core_get_cpt_single_module_template_part( 'templates/single/parts/info-title', 'portfolio', '', array( 'title' => $custom_field['item_title'] ) );
			} ?>
            <p>
				<?php if ( ! empty( $custom_field['item_url'] ) ) : ?>
                <a itemprop="url" target="_blank" href="<?php echo esc_url( $custom_field['item_url'] ); ?>"><?php endif; ?>
