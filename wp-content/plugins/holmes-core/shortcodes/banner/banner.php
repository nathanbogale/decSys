<?php
namespace HolmesCore\CPT\Shortcodes\Banner;
...
class Banner implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Banner', 'holmes-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Hover Behavior', 'holmes-core' ),
							'value'       => array(
								esc_html__( 'Visible on Hover', 'holmes-core' )   => 'mkdf-visible-on-hover',
								esc_html__( 'Visible on Default', 'holmes-core' ) => 'mkdf-visible-on-default',
								esc_html__( 'Disabled', 'holmes-core' )           => 'mkdf-disabled'
							),
							'save_always' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Info Position', 'holmes-core' ),
							'value'       => array(
								esc_html__( 'Default', 'holmes-core' )  => 'default',
								esc_html__( 'Centered', 'holmes-core' ) => 'centered'
							),
							'save_always' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Info Content Padding', 'holmes-core' ),
							'description' => esc_html__( 'Please insert padding in format top right bottom left', 'holmes-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'subtitle',
						...
						array(
							...
							'heading'     => esc_html__( 'Subtitle Tag', 'holmes-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Subtitle Color', 'holmes-core' ),
							'dependency' => array( 'element' => 'subtitle', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'    => esc_html__( 'Link Text', 'holmes-core' ),
							'dependency' => array( 'element' => 'link', 'not_empty' => true )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'link_color',
							'heading'    => esc_html__( 'Link Text Color', 'holmes-core' ),
							'dependency' => array( 'element' => 'link', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'link_top_margin',
							'heading'    => esc_html__( 'Link Text Top Margin (px)', 'holmes-core' ),
							'dependency' => array( 'element' => 'link', 'not_empty' => true )
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = holmes_core_get_shortcode_module_template_part( 'templates/banner', 'banner', '', $params );
	...
	private function getLinkStyles( $params ) {
		...
		if ( ! empty( $params['link_top_margin'] ) ) {
			$styles[] = 'margin-top: ' . holmes_mkdf_filter_px( $params['link_top_margin'] ) . 'px';
		}
