...
class ImageWithList implements Lib\ShortcodeInterface {
	private $base;
	
	function __construct() {
		$this->base = 'mkdf_image_with_list';
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Image With List', 'holmes-core' ),
					'base'                    => $this->base,
					'as_parent'               => array( 'only' => 'mkdf_image_with_list_item' ),
					'content_element'         => true,
					'category'                => esc_html__( 'by HOLMES', 'holmes-core' ),
					'icon'                    => 'icon-wpb-image-with-list extended-custom-icon',
	...
	public function render( $atts, $content = null ) {
		...
		$html = '<div class="mkdf-image-with-list mkdf-grid-list mkdf-disable-bottom-space clearfix ' . esc_attr( $holder_class ) . '">';
