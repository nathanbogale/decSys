<?php
namespace HolmesCore\CPT\Shortcodes\VerticalSplitSlider;
...
class VerticalSplitSlider implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'      => esc_html__( 'Vertical Split Slider', 'holmes-core' ),
					'base'      => $this->base,
					...
					'params'    => array(
						array(
							...
							'heading'    => esc_html__( 'Enable Scrolling Animation', 'holmes-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		$html = '<div class="mkdf-vertical-split-slider ' . esc_attr( $holder_classes ) . '">';
			...
			$html .= '<div class="mkdf-vss-vertical-arrow"><span class="ion ion-chevron-down"></span></div>';
		$html .= '</div>';
