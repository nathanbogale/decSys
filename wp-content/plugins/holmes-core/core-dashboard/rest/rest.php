...
if ( ! class_exists( 'HolmesCoreDashboardRestAPI' ) ) {
	 ...
	 */
	class HolmesCoreDashboardRestAPI {
		...
		public function __construct() {
			// Init variables
			$this->set_namespace( 'holmes-core/v1' );
			$this->set_route( 'dashboard' );

			// Localize theme's main js script with rest variable
			add_filter( 'holmes_core_dashboard_filter_js_global_variables', array( $this, 'localize_script' ) );
	...
	HolmesCoreDashboardRestAPI::get_instance();
}