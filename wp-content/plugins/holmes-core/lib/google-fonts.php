<?php
if ( ! function_exists( 'holmes_mkdf_init_google_fonts_array' ) ) {
    function holmes_mkdf_init_google_fonts_array() {

        global $holmes_fonts_array;
	    $google_fonts_json = '{
        ...
        $holmes_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'holmes_mkdf_init_google_fonts_array');
}