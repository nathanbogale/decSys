<div class="toggle-wrapper">
    <div class="list-row">
        ...
        <div class="list-content">
            <input type="text" placeholder="<?php echo __('- Field Label -', 'cost-calculator-builder')?>" v-model.trim="toggleField.label">
        </div>

        <div class="list-content">
            <input type="text" placeholder="<?php echo __('- Field Description -', 'cost-calculator-builder')?>" v-model.trim="toggleField.description">
        </div>
        ...
        <div class="list-header ccb-modal-list" style="margin-top: 38px">
            ...
            <h6><?php echo __('Currency Symbol On Total Description', 'cost-calculator-builder')?></h6>
        </div>
        ...
        <div class="list-header ccb-modal-list">
            ...
            <h6><?php echo __('Round Value', 'cost-calculator-builder')?></h6>
        </div>
        ...
        <div class="list-content">
            ...
            <div class="list-content--header">
                <button type="button" class="green" @click="addOption">
                    ...
                    <span><?php echo __('Add Toggle Options', 'cost-calculator-builder')?></span>
                </button>
            </div>
