...
class Tw_Custom_Post {
  ...
  private $tw_posts;
    ...
    public function tw_inits( $type, $singular_label, $plural_label, $settings = array() ){
        ...
        $this->tw_posts[$type] = array_merge($default_settings, $settings);
    }

    public function register_custom_post(){
        foreach($this->tw_posts as $key=>$value) {
