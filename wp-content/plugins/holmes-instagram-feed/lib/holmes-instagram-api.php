...
include 'holmes-instagram-helper.php';

/**
 * Class HolmesInstagramApi
 */
class HolmesInstagramApi {
	/**
	...
	private $apiURL;
	/**
	 * @var HolmesInstagramApi instance of current class
	 */
	private static $instance;
	
	/**
	 * Helper object
	 * @var HolmesInstagramHelper
	 */
	private $helper;
	
	const CODE_OPTION_NAME = 'holmes_instagram_code';
	const USER_ID_OPTION_NAME = 'holmes_instagram_user_id';
	const ACCESS_TOKEN_OPTION_NAME = 'holmes_instagram_access_token';
	const CODE_REDIRECT_URI_OPTION_NAME = 'holmes_instagram_code_redirect_uri';
	...
	public function __construct() {
		...
		$this->helper       = new HolmesInstagramHelper();
	}
	 ...
	 * @return string
	 *
	 * @see HolmesInstagramApi::buildCurrentPageURI()
	 */
	 ...
	 *
	 * @see HolmesInstagramApi::fetchData()
	 */
	 ...
	 * @return stdClass
	 *
	 * @see HolmesInstagramApi::getAccessToken()
	 */
