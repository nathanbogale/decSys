...
/**
 * Class HolmesInstagramHelper
 */
class HolmesInstagramHelper {
	/**
	 * Generates HTML for given image from Instagram feed. Defines holmes_instagram_image_atts filter
	 *
	...
	public function getImageHTML( $image, $imageSize ) {
		...
		$imageAtts = apply_filters( 'holmes_instagram_image_atts',
			array(
				'class'  => $imageSize,
